...
class LogisticRegressionModel(BaseModel):
    ...
    def get_param_space(self) -> Dict[str, ParamSpace]:
        return {
            'C': ParamSpace.categorical(choices=[10**i for i in range(-2, 3)], default=1.0), # Inverse of Regularization strength
            'penalty': ParamSpace.categorical(choices=['l1', 'l2'], default='l2'),
